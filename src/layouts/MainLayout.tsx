import { Accordion, Drawer, Slider, Tabs } from "@shared/ui";
import {
  AspireCard,
  BalanceDisplay,
  CardControlPanel,
...
export const MainLayout = () => {
  ...
  return (
    <div className="flex h-dvh overflow-hidden flex-col md:flex-row">
      <Sidebar />
      <main className="flex-1 overflow-hidden md:overflow-y-auto md:overflow-x-hidden p-8 pl-6 md:p-15 scrollbar-hidden bg-[#0C365A] md:bg-neutral-0 z-0">
      ...
      <Drawer open={true} classNames="md:hidden">
        <CardControlPanel />
